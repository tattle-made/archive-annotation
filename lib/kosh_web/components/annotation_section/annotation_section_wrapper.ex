defmodule KoshWeb.Components.AnnotationSection.AnnotationSectionWrapper do
  ...
  def update(new_assigns, socket) do
    ...
    total_user_annotations = Annotations.count_total_annotations_of_user(socket.assigns.current_user.id)
    total_annotations = Annotations.count_total_approved_annotations()
    socket = assign(socket, total_user_annotations: total_user_annotations, total_annotations: total_annotations)
