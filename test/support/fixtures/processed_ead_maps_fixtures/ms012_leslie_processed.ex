defmodule Kosh.ProcessedEADMapsFixtures.LeslieMap do
  @moduledoc false
      ...
      "ead" => %{
        "archdesc" => %{
          ...
          "controlaccess" => %{
            "famname" => "Coleman",
            "geogname" => [
              %{"content" => "Bangalore -- Karnataka -- India", "source" => "lcsh"},
              %{"content" => "Bombay -- British Raj -- India", "source" => "local"},
              ...
              %{"content" => "Tiptur -- Karnataka -- India", "source" => "lcsh"},
              %{"content" => "Halebidu -- Karnataka -- India", "source" => "local"},
              %{
              ...
              %{"content" => "Bellary -- Karnataka -- India", "source" => "local"},
              %{"content" => "Carlton House -- Bangalore", "source" => "local"},
              %{"content" => "Chamundi Hills -- Karnataka", "source" => "local"},
              ...
              %{
                "content" => "Fatehpur Sikri -- Agra -- United Provinces -- British Raj -- India",
                "source" => "local"
              },
              %{
              ...
              %{"content" => "Kolar -- Karnataka -- India", "source" => "local"},
              %{
              ...
              %{"content" => "Magadi -- Karnataka -- India", "source" => "local"},
              %{
              ...
              %{"content" => "Qutb Minar -- Delhi -- India", "source" => "local"},
              %{
              ...
              %{"content" => "Somanathapura -- Karnataka", "source" => "local"},
              %{
                "content" => "Thirthahalli -- Shimoga -- Karnataka",
                "source" => "local"
              },
              %{"content" => "Taj Mahal -- Agra -- India", "source" => "local"},
            ...
            "persname" => [
              "Coleman, L C (Leslie Charles) (1878-1954)",
              "Coleman, Ann",
              "Coleman, Louisa",
              "Coleman, Phebe",
              "Palmer, Luella C",
              "Morris, Randolph \"Ralph\" Camroux, Colonel, 1895-1977",
              "Nasiruddin, Syed",
              "Rao, D G Ramachandra",
              "Krishnayya, HV",
              "K.H., Srinivasan",
            ...
            "title" => [
              ...
              %{"content" => "Canada Lab of Plant Pathology", "source" => "local"},
              ...
              %{"content" => "Mysore Agricultural Department", "source" => "local"},
              %{"content" => "Mysore Planters Association", "source" => "local"},
          ...
          "did" => %{
            ...
            "unitid" => [
              "MS-012",
              %{"content" => "/repositories/2/resources/28", "type" => "aspace_uri"}
            ],
            ...
            "c" => [
                ...
                "c" => [
                    ...
                    "c" => [
                      ...
                      %{
                        "did" => %{
                          ...
                          "origination" => %{
                            "label" => "Creator",
                            "persname" => %{
                              "content" => "Ruhland, Eugen Otto Wilhelm, 1878-1960",
                              "role" => "aut"
                            }
                          },
                          "unitdate" => %{
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Rau, K.Venkatagiri, 10 December 1951"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                      ...
                      %{
                        "controlaccess" => %{
                          "persname" => "Hanumanthaiah, K (Kengal), 1908-1980"
                        },
                        "did" => %{
                          "container" => [
                            %{
                      ...
                      %{
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Pleasantries and reports on events in Mysore state."
                        }
                      },
                      %{
                        "did" => %{
                    ...
                    "c" => [
                      %{
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Discusses his journey from Gander to London."
                        }
                      },
                      %{
                        "controlaccess" => %{"famname" => "Coleman"},
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Discusses his journey to Karachi."
                        }
                      },
                      %{
                        "controlaccess" => %{"famname" => "Coleman"},
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Discusses his journey to Bombay."
                        }
                      },
                      %{
                        "controlaccess" => %{"famname" => "Coleman"},
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Discusses his welcome and stay at Bangalore."
                        }
                      },
                      %{
                        "controlaccess" => %{"famname" => "Coleman"},
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Concerning his stay in Mysore State."
                        }
                      },
                      %{
                        "controlaccess" => %{"persname" => "Coleman, Louisa"},
                        "did" => %{
                          "container" => [
                            %{
                              "content" => "MS-012 Box 1",
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Detailing events and anecdotes about his stay in Mysore state."
                        }
                      },
                      %{
                        "controlaccess" => %{"famname" => "Coleman"},
                      ...
                      %{
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Anecdotes about his stay in Mysore state."
                        }
                      },
                      %{
                        "did" => %{
                      ...
                      %{
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Detailing visit to Bellary during his tour of the Mysore state"
                        }
                      },
                      %{
                        "did" => %{
                      ...
                      %{
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Mentions last leg of Coleman's tour in Bangalore."
                        }
                      },
                      %{
                        "did" => %{
                      ...
                      %{
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Details his tour of Hoskote and Kolar."
                        }
                      },
                      %{
                        "did" => %{
                      ...
                      %{
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Regarding plans for London during journey back to Canada"
                        }
                      }
                    ],
                    "did" => %{
                      ...
                      "unittitle" => "Sub-Series 2: Letters from Leslie Coleman - Visit to India"
                    },
                  ...
                  %{
                    "c" => [
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Bangalore District Sericulture Conference"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Bangalore District Sericulture Conference",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                          ...
                          "unittitle" => "Bangalore District Sericulture Conference"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Taluk Agricultural and Experimental Union, Thirthahalli"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Taluk Agricultural and Experimental Union, Thirthahalli"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Chikmagalur District Agricultural and Experimental Union"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Mysore Sugar Company Limited, Mandya"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Mysore Sugar Company Limited, Mandya"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Mysore Agricultural and Experimental Union, Yelahanka"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Mysore Agricultural and Experimental Union, Yelahanka"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Chitradurga Taluk, Lakshmisagar Village Farmers"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Chitradurga Taluk, Lakshmisagar Village Farmers",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                          ...
                          "unittitle" => "Chitradurga Taluk, Lakshmisagar Village Farmers"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Mysore Agricultural and Experimental Union, Goridibinur"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Mysore Agricultural and Experimental Union, Goridibinur"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Taluk Agricultural Union, Magadi"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Taluk Agricultural Union, Magadi"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Kolar District Agricultural and Experimental Union"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Kolar District Agricultural and Experimental Union",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                            "content" => "19 February 1954",
                          ...
                          "unittitle" => "Kolar District Agricultural and Experimental Union"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Mysore Agricultural and Experimental Union, Bangarpet Taluk"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{"p" => "Mandya District Mahajans"},
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Mandya District Mahajans"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Village Panchayat, Bidadi, Ramanagaram Taluk"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Village Panchayat, Bidadi, Ramanagaram Taluk",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                          ...
                          "unittitle" => "Village Panchayat, Bidadi, Ramanagaram Taluk"
                        },
                    ...
                    "did" => %{
                      ...
                      "unittitle" => "Sub-Series 3: Tributes"
                    },
                ...
                "c" => [
                  ...
                  %{
                    "did" => %{
                      ...
                      "daogrp" => %{
                        "daodesc" => %{
                          "p" => "Cattle in the Indian agricultural economy"
                        },
                        "daoloc" => [
                          %{
                            "xlink:href" =>
                      ...
                      "unittitle" => "Cattle in the Indian agricultural economy"
                    },
                  ...
                  %{
                    "did" => %{
                      ...
                      "daogrp" => %{
                        "daodesc" => %{
                          "p" => "Reflections on visit to India in 1953-1954"
                        },
                        "daoloc" => [
                          %{
                            "xlink:href" =>
                        ...
                        "xlink:title" => " Reflections on visit to India in 1953-1954",
                        "xlink:type" => "extended"
                      },
                      "unitdate" => %{
                        "content" => "Undated",
                      ...
                      "unittitle" => "Reflections on visit to India in 1953-1954"
                    },
                  ...
                  %{
                    "did" => %{
                      ...
                      "daogrp" => %{
                        "daodesc" => %{"p" => "The South Indian Village"},
                        "daoloc" => [
                          %{
                            "xlink:href" =>
                      ...
                      "unittitle" => "The South Indian Village"
                    },
              ...
              %{
                "c" => [
                  %{
                    "did" => %{
                      ...
                      "daogrp" => %{
                        "daodesc" => %{
                          "p" => "India Director of Agriculture visits Danvers"
                        },
                        "daoloc" => [
                          %{
                            "xlink:href" =>
                        ...
                        "xlink:title" => "India Director of Agriculture visits Danvers",
                        "xlink:type" => "extended"
                      },
                      "unitdate" => %{
                      ...
                      "unittitle" => "India Director of Agriculture visits Danvers"
                    },
                  ...
                  %{
                    "did" => %{
                      ...
                      "daogrp" => %{
                        "daodesc" => %{
                          "p" => "Dr Leslie Coleman -- Services to Mysore Agriculture"
                        },
                        "daoloc" => [
                          %{
                            "xlink:href" =>
                        ...
                        "xlink:title" => "Dr Leslie Coleman -- Services to Mysore Agriculture",
                        "xlink:type" => "extended"
                      },
                      "unitdate" => %{
                        "content" => "ca 1933",
                      ...
                      "unittitle" => "Dr Leslie Coleman -- Services to Mysore Agriculture"
                    },
                  ...
                  %{
                    "did" => %{
                      ...
                      "daogrp" => %{
                        "daodesc" => %{
                          "p" => "An Investiture Ceremony, held at the Residency"
                        },
                        "daoloc" => [
                          %{
                            "xlink:href" =>
                        ...
                        "xlink:title" => "An Investiture Ceremony, held at the Residency",
                        "xlink:type" => "extended"
                      },
                      "unitdate" => %{
                        "content" => "ca 1933",
                      ...
                      "unittitle" => "An Investiture Ceremony, held at the Residency"
                    },
                  ...
                  %{
                    "did" => %{
                      ...
                      "daogrp" => %{
                        "daodesc" => %{"p" => "A Delightful Ceremony"},
                        "daoloc" => [
                          %{
                            "xlink:href" =>
                      ...
                      "unittitle" => "A Delightful Ceremony"
                    },
                ...
                "did" => %{
                  ...
                  "unittitle" => "Series 3: Media coverage"
                },
                "id" => "aspace_MS-012-3",
                "level" => "series"
              },
              %{
                "c" => [
                  %{
                    "did" => %{
                      ...
                      "daogrp" => %{
                        "daodesc" => %{
                          "p" => "The Ring Disease of Potatoes (A Preliminary Report)"
                        },
                        "daoloc" => [
                          %{
                            "xlink:href" =>
                        ...
                        "xlink:title" => "The Ring Disease of Potatoes (A Preliminary Report)",
                        "xlink:type" => "extended"
                      },
                      "unitdate" => %{"content" => "1909", "datechar" => "creation"},
                      "unitid" => [
                        "MS-012-4-0-3-9",
                        %{
                      ...
                      "unittitle" => "The Ring Disease of Potatoes (A Preliminary Report)"
                    },
                  ...
                  %{
                    "did" => %{
                      ...
                      "daogrp" => %{
                        "daodesc" => %{
                          "p" => "The Rice Grasshopper (Hieroglyphus banian, Fabr.)"
                        },
                        "daoloc" => [
                          %{
                            "xlink:href" =>
                        ...
                        "xlink:title" => "The Rice Grasshopper (Hieroglyphus banian, Fabr.)",
                        "xlink:type" => "extended"
                      },
                      "unitdate" => %{"content" => "1911", "datechar" => "creation"},
                      "unitid" => [
                        "MS-012-4-0-3-10",
                        %{
                      ...
                      "unittitle" => "The Rice Grasshopper (Hieroglyphus banian, Fabr.)"
                    },
                  ...
                  %{
                    "did" => %{
                      ...
                      "daogrp" => %{
                        "daodesc" => %{
                          "p" => "Experiments on Paddy Cultivation during the years 1909-11"
                        },
                        "daoloc" => [
                          %{
                            "xlink:href" =>
                      ...
                      "unitdate" => %{"content" => "1912", "datechar" => "creation"},
                      "unitid" => [
                        "MS-012-4-0-3-11",
                        %{
                      ...
                      "unittitle" => "Experiments on Paddy Cultivation during the years 1909-11"
                    },
                  ...
                  %{
                    "did" => %{
                      ...
                      "daogrp" => %{
                        "daodesc" => %{
                          "p" => "The Dead Arm Disease of Grapes in Ontario - A Preliminary Study"
                        },
                        "daoloc" => [
                          %{
                            "xlink:href" =>
                      ...
                      "unitdate" => %{"content" => "1928", "datechar" => "creation"},
                      "unitid" => [
                        "MS-012-4-0-3-12",
                        %{
                  ...
                  %{
                    "did" => %{
                      ...
                      "unitdate" => %{"content" => "1931", "datechar" => "creation"},
                      "unitid" => [
                        "MS-012-4-0-3-13",
                        %{
                  ...
                  %{
                    "did" => %{
                      ...
                      "unitdate" => %{"content" => "1947", "datechar" => "creation"},
                      "unitid" => [
                        "MS-012-4-0-3-14",
                        %{
                ...
                "did" => %{
                  ...
                  "unittitle" => "Series 4: Research reprints"
                },
                "id" => "aspace_MS-012-4",
                "level" => "series"
              },
              %{
                "c" => [
                  %{
                    "c" => [
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{"p" => "Mysore Sericulture Department"},
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Mysore Sericulture Department"
                        },
                    ...
                    "did" => %{
                      ...
                      "unittitle" => "Sub-Series 1: Family albums and work site albums"
                    },
                  ...
                  %{
                    "c" => [
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Group photograph: Leslie C Coleman, Davison and others"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Group photograph: Leslie C Coleman, Davison and others"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Group photograph: Leslie C Coleman and others"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Group photograph: Leslie C Coleman and others",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                            "content" => "Undated",
                          ...
                          "unittitle" => "Group photograph: Leslie C Coleman and others"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Group photograph: LCC and others"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Group photograph: LCC and others"
                        },
                    ...
                    "did" => %{
                      ...
                      "unittitle" => "Sub-Series 2: Group photographs with colleagues"
                    },
                  ...
                  %{
                    "c" => [
                      ...
                      %{
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Greeting card with photograph of the Mysore palace."
                        }
                      },
                      %{
                        "did" => %{
                    ...
                    "did" => %{
                      ...
                      "unittitle" => "Sub-Series 3: Greeting cards"
                    },
                    ...
                    "c" => [
                      ...
                      %{
                        "did" => %{
                          ...
                          "unittitle" => "Loose Photos -- Part 2 of 7 -- Family and home in India"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Loose Photos -- Part 3 of 7 -- Family and home in India"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Loose Photos -- Part 3 of 7 -- Family and home in India"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Loose Photos -- Part 6 of 7 -- Work and related individuals"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Loose Photos -- Part 7 of 7 -- Travels"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Loose Photos -- Part 7 of 7 -- Travels",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                            "content" => "Undated",
                          ...
                          "unittitle" => "Loose Photos -- Part 7 of 7 -- Travels"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Mysore royal family (Wadiyar) procession"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Mysore royal family (Wadiyar) procession",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                            "content" => "Undated",
                          ...
                          "unittitle" => "Mysore royal family (Wadiyar) procession"
                        },
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Krishnaraja Wadiyar on horse, in a procession."
                        }
                      },
                      %{
                        "did" => %{
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Unknown profile photograph (military attire)"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Unknown profile photograph (military attire)",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                            "content" => "Undated",
                          ...
                          "unittitle" => "Unknown profile photograph (military attire)"
                        },
                      ...
                      %{
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Scribbled on back: \"Colonel Crawford??\""
                        }
                      },
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{"p" => "Field site, unidentified"},
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Field site, unidentified"
                        },
                  ...
                  %{
                    "c" => [
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Department of Agriculture, Mysore -- 1954 Visit to India"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                    ...
                    "did" => %{
                      ...
                      "unittitle" => "Sub-Series 5: Visit to India, 1953-1954"
                    },
                ...
                "did" => %{
                  ...
                  "unittitle" => "Series 5: Photographs"
                },
                "id" => "aspace_MS-012-5",
                "level" => "series"
              },
              %{
                "c" => [
                  %{
                    "c" => [
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{"p" => "H.F Murland - Ms. Coleman"},
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "H.F Murland - Ms. Coleman"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Unknown sender - Canada Lab of Plant Pathology"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Unknown sender - Canada Lab of Plant Pathology",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                          ...
                          "unittitle" => "Unknown sender - Canada Lab of Plant Pathology"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{"p" => "R. Keith Hicks - Bertha Coleman"},
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "R. Keith Hicks - Bertha Coleman"
                        },
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Offers condolences to Coleman Family."
                        }
                      },
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "T.M.C Taylor - Dominion Laboratory"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "T.M.C Taylor - Dominion Laboratory"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "V.M Lingiah (Mysore Sugar Company) - Canada Laboratory"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "V.M Lingiah (Mysore Sugar Company) - Canada Laboratory"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Director of Agriculture (Mysore State) - Ann Coleman"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Director of Agriculture (Mysore State) - Ann Coleman"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Chief Secretary (Government of Mysore) - Plant Pathology"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{"p" => "Syed Nasiruddin - Mrs. Coleman"},
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Syed Nasiruddin - Mrs. Coleman"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{"p" => "Mary White - Bertha Coleman"},
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Mary White - Bertha Coleman"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Leila Srinivasan - Bertha Coleman"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Leila Srinivasan - Bertha Coleman"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Leslie Jr. - Bertha Coleman and Mrs. L Palmer"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Leslie Jr. - Bertha Coleman and Mrs. L Palmer",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                          ...
                          "unittitle" => "Leslie Jr. - Bertha Coleman and Mrs. L Palmer"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Mrs. McKeen - Bertha Coleman, Mrs. L Palmer"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Mrs. McKeen - Bertha Coleman, Mrs. L Palmer",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                            "content" => "24 September 1954",
                          ...
                          "unittitle" => "Mrs. McKeen - Bertha Coleman, Mrs. L Palmer"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "AgriUnion Gouribidanur - Mrs. Coleman"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "AgriUnion Gouribidanur - Mrs. Coleman",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                            "content" => "5 October 1954",
                          ...
                          "unittitle" => "AgriUnion Gouribidanur - Mrs. Coleman"
                        },
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Telegram offering condolences to Coleman family."
                        }
                      },
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Muriel Hutchinson - Bertha Coleman"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Muriel Hutchinson - Bertha Coleman"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "H.V Krishnayya - Bertha Coleman, Mrs. L Palmer"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "H.V Krishnayya - Bertha Coleman, Mrs. L Palmer",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                          ...
                          "unittitle" => "H.V Krishnayya - Bertha Coleman, Mrs. L Palmer"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "G.V Krishnamurthy - Mrs. Coleman"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "G.V Krishnamurthy - Mrs. Coleman"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{"p" => "Howard F. Murland - Ms Coleman"},
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Howard F. Murland - Ms Coleman"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{"p" => "H.V Krishnayya - Ms Coleman"},
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "H.V Krishnayya - Ms Coleman"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{"p" => "WHP Baeilli - Mrs. Coleman"},
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "WHP Baeilli - Mrs. Coleman"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "FAG Ratcliff (Mysore Planters Association) - Ms. Coleman"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "George Setterfield - Mrs. Palmer"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "George Setterfield - Mrs. Palmer"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Botany Department (University of Toronto)"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Botany Department (University of Toronto)",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                            "content" => "Undated",
                          ...
                          "unittitle" => "Botany Department (University of Toronto)"
                        },
                    ...
                    "did" => %{
                      ...
                      "unittitle" => "Sub-Series 1: Correspondence"
                    },
                    ...
                    "c" => [
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Dr. L.C Coleman Victim of Crash- The Daily Times"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Dr. L.C Coleman Victim of Crash- The Daily Times",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                            "content" => "14 September 1954",
                          ...
                          "unittitle" => "Dr. L.C Coleman Victim of Crash- The Daily Times"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Tribute paid to Dr. Coleman- The Colonist"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Tribute paid to Dr. Coleman- The Colonist",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                            "content" => "15 September 1954",
                          ...
                          "unittitle" => "Tribute paid to Dr. Coleman- The Colonist"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Research Worker- Tribute Article"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Research Worker- Tribute Article"
                        },
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Details Coleman's work in India."
                        }
                      },
                      %{
                        "did" => %{
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Contains details of Coleman's funeral."
                        }
                      },
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Prominent doctor dies after crash - Calgary Paper"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Prominent doctor dies after crash - Calgary Paper",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                            "content" => "Circa September 1954",
                          ...
                          "unittitle" => "Prominent doctor dies after crash - Calgary Paper"
                        },
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Mentions the car accident and Coleman's death."
                        }
                      }
                    ],
                    "did" => %{
                      ...
                      "unittitle" => "Sub-Series 2: Media coverage"
                    },
                ...
                "did" => %{
                  ...
                  "unittitle" => "Series 6: Material related to Coleman's demise"
                },
                "id" => "aspace_MS-012-6",
                "level" => "series"
              },
              %{
                "c" => [
                  %{
                    "c" => [
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{"p" => "Notes on Coleman Family history"},
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Notes on Coleman Family history"
                        },
                    ...
                    "did" => %{
                      ...
                      "unittitle" => "Sub-Series 1: Notes on Coleman family history"
                    },
                  ...
                  %{
                    "c" => [
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Srinivasan, Jayalakshamma - Tom and Ann Widdowson"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Srinivasan, Jayalakshamma - Tom and Ann Widdowson",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                          ...
                          "unittitle" => "Srinivasan, Jayalakshamma - Tom and Ann Widdowson"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Ann and Tom Widdowson - Dr Puttaswamy (UAS)"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Ann and Tom Widdowson - Dr Puttaswamy (UAS)",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                          ...
                          "unittitle" => "Ann and Tom Widdowson - Dr Puttaswamy (UAS)"
                        },
                    ...
                    "did" => %{
                      ...
                      "unittitle" => "Sub-Series 2: Correspondence"
                    },
                ...
                "did" => %{
                  ...
                  "unittitle" => "Series 7: Other material from Coleman family"
                },
                "id" => "aspace_MS-012-7",
                "level" => "series"
              },
              %{
                "c" => [
                  %{
                    "c" => [
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Invitation - Inauguration of Coleman Lecture Series"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Invitation- Inauguration of Coleman Lecture Series"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Programme Inaugural function of Coleman Lecture Series"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                          ...
                          "unittitle" => "Programme Inaugural function of Coleman Lecture Series"
                        },
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Programme list for the Coleman Lecture Series."
                        }
                      },
                      %{
                        "did" => %{
                          ...
                          "unittitle" => "Coleman Lecture Brochure"
                        },
                    ...
                    "did" => %{
                      ...
                      "unittitle" => "Sub-Series 1: Coleman Lectures"
                    },
                  ...
                  %{
                    "c" => [
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "'Krishi Yogi Coleman'- Book by Annaiah Kiragandur"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "'Krishi Yogi Coleman'- Book by Annaiah Kiragandur",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                          ...
                          "unittitle" => "'Krishi Yogi Coleman' - Book by Annaiah Kiragandur"
                        },
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Booklet in Kannada on Coleman written by Anniah Kiragandur."
                        }
                      },
                      %{
                        "did" => %{
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Excerpts from Biographical Notes on Coleman"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Excerpts from Biographical Notes on Coleman",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                            "content" => "Undated",
                          ...
                          "unittitle" => "Excerpts from Biographical Notes on Coleman"
                        },
                      ...
                      %{
                        "did" => %{
                          ...
                          "daogrp" => %{
                            "daodesc" => %{
                              "p" => "Excerpts from the Biographical notes on Coleman"
                            },
                            "daoloc" => [
                              %{
                                "xlink:href" =>
                            ...
                            "xlink:title" => "Excerpts from the Biographical notes on Coleman",
                            "xlink:type" => "extended"
                          },
                          "unitdate" => %{
                            "content" => "Undated",
                          ...
                          "unittitle" => "Excerpts from the Biographical notes on Coleman"
                        },
                    ...
                    "did" => %{
                      ...
                      "unittitle" => "Sub-Series 2: Material Related to Coleman"
                    },
                  ...
                  %{
                    "c" => [
                      %{
                        "did" => %{
                          ...
                          "unittitle" => "Contacts of Ann Widdowson"
                        },
                        ...
                        "scopecontent" => %{
                          ...
                          "p" => "Business cards of Ann Widdowson's acquaintances."
                        }
                      },
                      %{
                        "did" => %{
                    ...
                    "did" => %{
                      ...
                      "unittitle" => "Sub-Series 3: Ann Widdowson Ephemera"
                    },
                ...
                "did" => %{
                  ...
                  "unittitle" => "Series 8: Material collected by Ann Widdowson"
                },
                "id" => "aspace_MS-012-8",
                "level" => "series"
              }
          ...
          "prefercite" => %{
            ...
            "p" => "MS-012, Leslie Coleman Papers, Archives at NCBS"
          },
          "scopecontent" => %{
        ...
        "eadheader" => %{
          ...
          "profiledesc" => %{
            "creation" => %{
              "content" => ["This finding aid was produced using ArchivesSpace on", "."],
              "date" => "2025-04-23 18:28:34 +0530"
            },
